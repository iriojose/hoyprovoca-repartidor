  ...
  <v-card class="fixHeight" style="background:transparent;border: none;padding:25px;" outlined>
    ...
    <v-row justify="center" align="center" class="mt-3" style="padding-top:15px;">
      <v-scroll-x-transition>
        <div id="talkjs-container" style="width: 100%;; height: 450px">
          <i>
            <v-spacer></v-spacer>
            <v-spacer></v-spacer>
          </i>
    ...
    init() {
      ...
      Talk.ready.then(async () => {
        this.me = new Talk.User({
          ...
          photoUrl:
            this.user.data.id !== 2
              ? this.user.data.imagen === "default.png"
                ? require("@/assets/user.jpg")
                : this.image + this.user.data.imagen
              : require("@/assets/2.png"),
          welcomeMessage:
            this.user.data.id !== 2
              ? "Hola, soy " + this.user.data.nombre
